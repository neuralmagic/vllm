...
from benchmark_lora import as_benchmark_contexts
from benchmark_lora import BenchmarkContext, BenchmarkTensors
from benchmark_lora import OpType
...
def tune_optype(ctx: BenchmarkContext, op_type: OpType, add_input_arg: bool, test_correctness: bool = False):
            ...
            for bench_op in bench_ops:
                for num_slices in bench_op.num_slices():
                    ...
                    for add_input_arg in expand_fn_add_inputs:
                        tune_optype(_ctx, bench_op, add_input_arg, args.test_correctness)
