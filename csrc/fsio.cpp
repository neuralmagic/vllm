...
static PyMethodDef fsio_C_methods[] = {
...
static struct PyModuleDef fsio_C_module = {
    PyModuleDef_HEAD_INIT,
    "fsio_C",
    "Filesystem helpers for KV offload (batch stat/store/load)",
    -1,
    fsio_C_methods,
};

PyMODINIT_FUNC PyInit_fsio_C(void) { return PyModule_Create(&fsio_C_module); }
