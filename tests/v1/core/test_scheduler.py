...
def test_stop_via_update_from_output():
    ...
    # requesttest[0].num_computed_tokens = requests[0].num_tokens
...
def _step_until_done(
    ...
    output: SchedulerOutput,
    model_runner_output: ModelRunnerOutput,
    output_already_processed: bool = False,
):
    ...
    while not all_finished:
        ...
        ecos = scheduler_update_from_output_sync(scheduler, output, model_runner_output)[0]
...
def test_kv_connector_basic():
    ...
    _step_until_done(scheduler, output, MODEL_RUNNER_OUTPUT, output_already_processed=True)
