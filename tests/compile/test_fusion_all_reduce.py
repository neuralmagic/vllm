...
class TestAllReduceFusedAddRMSNormStaticQuantFP4Model(torch.nn.Module):
    ...
    def __init__(self, hidden_size=16, token_num=16, eps=1e-6):
        ...
        wq_gen, wscale_gen = zip(*(scaled_fp4_quant(w, wg)
                                   for w, wg in zip(self.w, wgscale)))
