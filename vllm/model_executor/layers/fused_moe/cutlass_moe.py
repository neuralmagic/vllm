...
def cutlass_moe_fp8_test(
    ...
    per_act_token = a1_scale.numel() != 1 if a1_scale is not None else (
        a2_scale.numel() != 1 if a2_scale is not None else False)
    per_out_ch = w1_scale.numel() != num_experts
    ...
    ops.cutlass_moe_mm(c1, rep_a_q, w1_q, rep_a1_scales, w1_scale,
                       ...
                       ab_strides1, c_strides1, per_act_token, per_out_ch)
    ...
    ops.cutlass_moe_mm(c2, intemediate_q, w2_q, a2_scale, w2_scale,
                       ...
                       ab_strides2, c_strides2, per_act_token, per_out_ch)
    # Gather tokens
