...
def batched_fused_marlin_moe(
    ...
    # TODO: Choose a decent block size like in fused_marlin_moe
    block_size_m = 32
    ...
    sorted_token_ids, expert_ids, num_tokens_post_padded = (None, None, None)

    # TODO (varun) : Update M - expand the tensor first !
