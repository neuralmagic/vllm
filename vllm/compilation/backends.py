...
from .config import CompilationConfig, PassConfig
...
class PostGradPassManager:
    ...
    def __init__(self, passes: Sequence[Callable] = ()):
        ...
        self.has_custom_passes = len(passes) > 0
...
class VllmBackend:
    ...
    def __init__(self, extra_post_grad_passes: Sequence[Callable] = ()):
