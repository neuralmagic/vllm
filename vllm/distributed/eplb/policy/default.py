...
class DefaultEplbPolicy(AbstractEplbPolicy):
    ...
    def preserve_intragpu_slots(
        ...
        post_phy2log_np = phy2log.copy()
        post_phyrank_np = phyrank.copy()
        ...
        return post_phy2log_np, post_phyrank_np
    ...
    def rebalance_experts(
        ...
        if num_groups % num_nodes == 0:
            ...
            phy2log_np, phyrank_np, logcnt_np = cls.rebalance_experts_hierarchical(
        ...
        if old_np is not None:
            phy2log_np, phyrank_np = cls.preserve_intragpu_slots(
                phy2log_np, phyrank_np, num_ranks, old_np
            )
        ...
        log2phy_np[layer_indices, phy2log_np, phyrank_np] = replica_indices
